...
const users = [
    { name: 'Admin User', email: 'admin@Eventra.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@Eventra.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@Eventra.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@Eventra.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@Eventra.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@Eventra.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@Eventra.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@Eventra.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@Eventra.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@Eventra.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        await mongoose.connect(process.env.MONGO_URL || 'mongodb://localhost:27017/Eventra');
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@Eventra.com');
        console.log('User Email:  user@Eventra.com');
